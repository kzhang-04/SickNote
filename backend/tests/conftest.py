...
def client_fixture() -> TestClient:
    # clean test client and db for each test
...
def student_auth_headers(
    ...
    # Creates a student user, logs in via /auth/login, and returns Authorization headers for that student.
...
def professor_auth_headers(
    ...
    # Creates a professor user, logs in via /auth/login, and returns Authorization headers for that professor.
